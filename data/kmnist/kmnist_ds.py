...
class KMNISTDataset(CDataSetBase):
  # --------------------------------------------------------------------------------------
  def __init__(self, datasets_folder, variation=""):
    super(KMNISTDataset, self).__init__(p_sName="kmnist")  #means: ku-zu-shi-ji Modified National Institute of Standards and Technology
  ...
  # --------------------------------------------------------------------------------------
  def load(self):
    self.LoadCache(self.fs, p_sTargetsFilePrefix="Labels")
  # --------------------------------------------------------------------------------------
