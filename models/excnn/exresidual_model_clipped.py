...
from keras.layers import BatchNormalization, Activation, AveragePooling2D, ZeroPadding2D

from models.layer_activation_collection import CLayerActivationCollection
import tensorflow as tf
import keras.layers as layers
# from models.layers.lateral_inhibition_pyramid import LateralInhibitionPyramidExplainer
from models.layers.lateral_inhibition import LateralInhibitionExplainer


# =========================================================================================================================
class ActivationClipper(layers.Layer):
    def __init__(self, min_value, max_value):
        super(ActivationClipper, self).__init__()
...
# =========================================================================================================================
class RExplaiNetModuleClipped(layers.Layer):
  # --------------------------------------------------------------------------------------------------------
  def __init__(self, p_nFeatures, p_nStrideOnInput, p_eModuleType, p_nWeightDecay, p_nResidualConnectionType,
               batchnorm_momentum=None, batchnorm_epsilon=None, p_bIsAnalyzing=False):
    super(RExplaiNetModuleClipped, self).__init__()
  ...
  def CreateBlock(self):
    ...
    self.Clipper6 = ActivationClipper(-6.0, 6.0)
  ...
  def call(self, p_tInput):
    ...
    a = self.Conv2(a)
    a = self.Clipper6(a)
    a, tS, tExplanation = self.LateralInhibitor(a)
    '''
