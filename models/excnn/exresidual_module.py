...
from keras.layers import InputLayer, Flatten, Dense, BatchNormalization, Activation, Softmax, AveragePooling2D, \
...
# =========================================================================================================================
class ExResidualModule(layers.Layer):
  # --------------------------------------------------------------------------------------------------------
  def __init__(self, p_nFeatures, p_nStrideOnInput, p_eModuleType, p_nWeightDecay, batchnorm_momentum=0.99,
    ...
    super(ExResidualModule, self).__init__()
