...
# =========================================================================================================================
class CRExplaiNetModule(layers.Layer):
    # --------------------------------------------------------------------------------------------------------
    def __init__(self, p_nFeatures,  p_nStrideOnInput, p_eModuleType, p_nWeightDecay, p_nResidualConnectionType, batchnorm_momentum=None, batchnorm_epsilon=None, p_bIsAnalyzing=False):
        super(CRExplaiNetModule, self).__init__()
